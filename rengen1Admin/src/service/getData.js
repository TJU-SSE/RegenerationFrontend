...
var updateLogo = (data) => fetch('POST', 'admin/designer/updateTitleImg', data, 'upload')

var updateCover = (data) => fetch('POST', 'admin/designer/updateImg', data, 'upload')
...
var updateImgCampaignRank = (data) => fetch('POST', 'admin/campaign/updateRanks', data)
...
var deleteImgLookbook = (data) => fetch('POST', 'admin/lookbook/deleteImg', data, 'upload')

var updateImgLookbookRank = (data) => fetch('POST', 'admin/lookbook/updateRanks', data)
...
var updateImgCooperationRank = (data) => fetch('POST', 'admin/cooperation/updateRanks', data)
...
var updateImgBrandingRank = (data) => fetch('POST', 'admin/branding/updateRanks', data)
...
var updateShowRank = (data) => fetch('POST', 'admin/show/updateRanks', data)

var updateImgShowRank = (data) => fetch('POST', 'admin/show/updateShowImgRanks', data)
...
var deleteSeason = (data) => fetch('POST', 'admin/show/deleteSeason', data, 'upload')
...
export {
    ...
    getAllJsons,
    setJson,
    updateImgCampaignRank,
    updateImgCooperationRank,
    updateImgBrandingRank,
    updateImgLookbookRank,
    updateImgShowRank,
    getSeasons,
    getAllBySeason,
    createSeason,
